...
pub mod ierc4906 {
    ...
    pub static IERC4906_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> = ::ethers::contract::Lazy::new(
        __abi,
    );
    pub struct IERC4906<M>(::ethers::contract::Contract<M>);
    ...
    impl<M> ::core::fmt::Debug for IERC4906<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(::core::stringify!(IERC4906)).field(&self.address()).finish()
        }
    }
    impl<M: ::ethers::providers::Middleware> IERC4906<M> {
    ...
    impl ::ethers::contract::EthLogDecode for IERC4906Events {
        fn decode_log(
    ...
    impl ::ethers::core::abi::AbiDecode for IERC4906Calls {
        fn decode(
            data: impl AsRef<[u8]>,
    ...
    impl ::ethers::core::abi::AbiEncode for IERC4906Calls {
