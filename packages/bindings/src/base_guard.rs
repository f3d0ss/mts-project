...
pub mod base_guard {
    ...
    pub static BASEGUARD_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> = ::ethers::contract::Lazy::new(
        __abi,
    );
    pub struct BaseGuard<M>(::ethers::contract::Contract<M>);
    impl<M> ::core::clone::Clone for BaseGuard<M> {
        fn clone(&self) -> Self {
            Self(::core::clone::Clone::clone(&self.0))
        }
    }
    impl<M> ::core::ops::Deref for BaseGuard<M> {
        type Target = ::ethers::contract::Contract<M>;
        fn deref(&self) -> &Self::Target {
            &self.0
        }
    }
    impl<M> ::core::ops::DerefMut for BaseGuard<M> {
        fn deref_mut(&mut self) -> &mut Self::Target {
            &mut self.0
        }
    }
    impl<M> ::core::fmt::Debug for BaseGuard<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(::core::stringify!(BaseGuard)).field(&self.address()).finish()
        }
    }
    impl<M: ::ethers::providers::Middleware> BaseGuard<M> {
    ...
    impl ::ethers::core::abi::AbiDecode for BaseGuardCalls {
        fn decode(
            data: impl AsRef<[u8]>,
    ...
    impl ::ethers::core::abi::AbiEncode for BaseGuardCalls {
    ...
    impl ::core::fmt::Display for BaseGuardCalls {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
                Self::CheckAfterExecution(element) => {
    ...
    impl ::core::convert::From<CheckAfterExecutionCall> for BaseGuardCalls {
        fn from(value: CheckAfterExecutionCall) -> Self {
            Self::CheckAfterExecution(value)
        }
    }
    impl ::core::convert::From<CheckTransactionCall> for BaseGuardCalls {
        fn from(value: CheckTransactionCall) -> Self {
            Self::CheckTransaction(value)
        }
    }
    impl ::core::convert::From<SupportsInterfaceCall> for BaseGuardCalls {
